...
public class DBConfiguration {
  ...
  @Bean
	public SessionFactory sessionFactory() {
		...
		Class classes[]=new Class[]{User.class,Job.class, BlogPost.class,BlogComment.class, Notification.class, Friend.class, ProfilePicture.class};//class objects of all entities
